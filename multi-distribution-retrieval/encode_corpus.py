...
from mdr.retrieval.models.retriever import CtxEncoder, RobertaCtxEncoder, BertCtxEncoder
...
def main():
    ...
    if not os.path.exists(f"{args.embed_save_path}/idx.npy"):
        ...
        if "roberta" in args.model_name:
            ...
            model = BertCtxEncoder(bert_config, args)
        # else:
        ...
        if args.init_checkpoint != args.model_name:
