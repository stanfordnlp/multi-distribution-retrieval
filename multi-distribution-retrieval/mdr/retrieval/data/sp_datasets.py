...
class SPDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if neg_title:
            ...
            neg_codes = self.tokenizer.encode_plus(neg_paragraph, max_length=self.max_c_len, return_tensors="pt")
        ...
        if pos_title:
            ...
            pos_codes = self.tokenizer.encode_plus(paragraph, max_length=self.max_c_len, return_tensors="pt")
